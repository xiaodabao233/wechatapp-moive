    ...
    <view class="container" v-if="order">
        <view class="ticket-content">
            ...
            <view class="divider-box">
                ...
                <image class="status" src="/static/assets/images/status.png"></image>
            </view>
            <view class="code-container">
                ...
                <view class="rq">
                    <image src="/static/assets/images/qr.png"></image>
                </view>
            </view>
        </view>
        ...
        <view class="map-box">
            <cinemaMap compName="cinemaMap" :data="{ cinemaData: order.cinemaData }"></cinemaMap>
        </view>
