	  ...
	  <view>
	    <view class='order'>
	      ...
	      <view class='order-list'>
	        <navigator class='order-item' url='movie-order/movie-order.vue' hover-class='none'>
	          <image src='/static/img/dianydingdan.png'></image>
	          <view>电影</view>
	        </navigator>
	        <navigator class='order-item' url='../../subPages/snack-order/snack-order' hover-class='none'>
	          <image src='/static/img/xiaochi.png'></image>
	          <view>小吃</view>
	        </navigator>
	      </view>
	    </view>
...
<style>
	...
	.header {
	  ...
	  align-items: center;
	  background-image: url('https://s0.meituan.net/bs/file/?f=my-canary:deploy/dpmmweb/client/dpmmweb/component/mycenter/img/bg.png');
